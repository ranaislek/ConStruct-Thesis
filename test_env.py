#!/usr/bin/env python3
"""
Cluster/ConStruct Environment Quick Sanity Check
Checks RDKit, torch, CUDA, torch-geometric, fcd, and your local package.
...
def main():
    print("\nConStruct Cluster Environment Sanity Check")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    if all_passed:
        print("🎉  ALL CHECKS PASSED: Your environment is ready for ConStruct!")
        print("You are safe to run your experiments. Good luck!")
    else:
