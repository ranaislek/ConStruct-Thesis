#!/bin/bash
#SBATCH --job-name=qm9_ring_count_at_least_2_marginal_test
#SBATCH --output=/home/rislek/ConStruct-Thesis/ConStruct/logs/qm9_ring_count_at_least_2_marginal_test_%j.out
#SBATCH --ntasks=1
...
echo "Starting ring_count_at_least_2_marginal_test experiment..."
echo "Job ID: $SLURM_JOB_ID"
echo "Node: $SLURM_NODELIST"
echo "Time: $(date)"

# Run the experiment with MarginalTransition
python ConStruct/main.py +experiment=debug/edge_insertion/ring_count_at_least/qm9_debug_ring_count_at_least_2_marginal_test
